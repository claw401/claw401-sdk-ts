...
var nacl2__default = /*#__PURE__*/_interopDefault(nacl2);
...
function verifySignature(options) {
  ...
  const valid = nacl2__default.default.sign.detached.verify(payload, sigBytes, pubkeyBytes);
  if (!valid) {
...
async function signProof(options) {
  ...
  const sigBytes = nacl2__default.default.sign.detached(payloadBytes, issuerSecretKey);
...
function verifyProof(options) {
  ...
  let pubkeyBytes;
  try {
    pubkeyBytes = new web3_js.PublicKey(proof.issuer).toBytes();
  } catch {
  ...
  const valid = nacl2__default.default.sign.detached.verify(payloadBytes, sigBytes, pubkeyBytes);
  if (!valid) {
...
async function createAgentAttestation(options) {
  ...
  const payloadBytes = canonicalize(payload);
  const sigBytes = nacl2__default.default.sign.detached(payloadBytes, operatorSecretKey);
  return { ...payload, signature: bytesToBase64(sigBytes) };
}
function verifyAgentAttestation(options) {
  ...
  try {
    operatorPubkeyBytes = new web3_js.PublicKey(attestation.operatorKey).toBytes();
  } catch {
  ...
  const valid = nacl2__default.default.sign.detached.verify(payloadBytes, sigBytes, operatorPubkeyBytes);
  if (!valid) {
...
exports.DEFAULT_CHALLENGE_TTL_MS = DEFAULT_CHALLENGE_TTL_MS;
exports.DEFAULT_SESSION_TTL_MS = DEFAULT_SESSION_TTL_MS;
exports.InMemoryNonceCache = InMemoryNonceCache;
exports.PROTOCOL_VERSION = PROTOCOL_VERSION;
exports.base64ToBytes = base64ToBytes;
exports.bytesToBase64 = bytesToBase64;
exports.bytesToHex = bytesToHex;
exports.canonicalize = canonicalize;
exports.challengeSigningBytes = challengeSigningBytes;
exports.createAgentAttestation = createAgentAttestation;
exports.createSession = createSession;
exports.deriveAttestationId = deriveAttestationId;
exports.deriveSessionId = deriveSessionId;
exports.deserializeAttestation = deserializeAttestation;
exports.deserializeSession = deserializeSession;
exports.encodeSignature = encodeSignature;
exports.generateChallenge = generateChallenge;
exports.generateNonce = generateNonce;
exports.hexToBytes = hexToBytes;
exports.serializeAttestation = serializeAttestation;
exports.serializeSession = serializeSession;
exports.sha256Hex = sha256Hex;
exports.signProof = signProof;
exports.stringToBytes = stringToBytes;
exports.verifyAgentAttestation = verifyAgentAttestation;
